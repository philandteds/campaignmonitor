...
class CS_REST_Transactional_ClassicEmail extends CS_REST_Wrapper_Base {
     ...
     * @param $apiVersion The api version to embed in the URL (defaults to v3.1 for the transactional API)
     * @access public
     */
    function __construct (
        ...
        $this->CS_REST_Wrapper_Base($auth_details, $protocol, $debug_level, $host, $log, $serialiser, $transport, $apiVersion);
